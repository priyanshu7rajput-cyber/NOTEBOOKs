...
export const BOOK_THEMES: Record<CoverTheme, ThemeConfig> = {
  spiral_black: {
    id: "spiral_black",
    name: "Matte Black Spiral",
    category: "Spiral & Ring",
    gradient: "from-zinc-900 via-neutral-900 to-black",
    accent: "#eab308", // Gold frame & pen
    border: "border-yellow-600/60",
    text: "text-amber-100",
  },
  spiral_gold: {
    id: "spiral_gold",
    name: "Golden Wire Diary",
    category: "Spiral & Ring",
    gradient: "from-stone-900 via-neutral-800 to-zinc-900",
    accent: "#d4af37",
